...
return [
    ...
    'title' => [
         ...
         */
        'homepage_title' => 'Blaze Grids - Seu site de históricos para crash e double',
    ],
    ...
    'description' => [
         ...
         */
        'fallback' => 'Busque por vários históricos da blaze dos jogos crash e double, monte seu kit blaze aqui e faça apostas mais certeiras com os nosso histórico detalhado.',
    ],
