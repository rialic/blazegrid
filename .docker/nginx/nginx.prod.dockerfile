...
ADD ./blazegrids.prod.conf /etc/nginx/sites-available/blazegrids.prod.conf
...
&& ln -s /etc/nginx/sites-available/blazegrids.prod.conf /etc/nginx/sites-enabled/blazegrids.prod.conf \
# CRON CONFIGURATION
