...
var _ref = function () {
  ...
  function _defaultHistory() {
    _defaultHistory = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      var url, response;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              throw new Error("message: ".concat(response.statusText, ", code: ").concat(response.status));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "renderDefaultHistoryView": () => (/* binding */ renderDefaultHistoryView)
/* harmony export */ });
...
var _ref = function () {
  function renderDefaultHistoryView(data) {
    ...
    data.forEach(function (crash) {
      ...
      var badgeDiv = (0,_utilx__WEBPACK_IMPORTED_MODULE_0__.makeElement)('div', {
        "class": "badge bg-".concat(pointColor)
      });
  ...
  return {
    renderDefaultHistoryView: renderDefaultHistoryView
  };
}(),
    renderDefaultHistoryView = _ref.renderDefaultHistoryView;
...
/* harmony import */ var _utilx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utilx */ "./resources/js/utilx.js");
/* harmony import */ var _api_crash_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../api/crash-api */ "./resources/js/api/crash-api.js");
/* harmony import */ var _templates_crash_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../templates/crash-view */ "./resources/js/templates/crash-view.js");
...
_app__WEBPACK_IMPORTED_MODULE_1__["default"].Crash = function () {
  ...
  Crash.prototype.init = function () {
    ...
    this.refreshDefaultBtn.addEventListener('click', function (event) {
      return refreshHistory.call(_this, event);
    });
  };
  ...
  function refreshHistory(event) {
    ...
    var refreshList = {
      'refresh-default': refreshDefault,
      'refresh-advanced': refreshAdvanced
    };

    if ((0,_utilx__WEBPACK_IMPORTED_MODULE_2__.empty)(refreshButtonName)) {
      return;
    }
  ...
  function refreshDefault() {
    return _refreshDefault.apply(this, arguments);
  }

  function _refreshDefault() {
    _refreshDefault = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      var response, data;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0,_api_crash_api__WEBPACK_IMPORTED_MODULE_3__.defaultHistory)();

            case 2:
              response = _context.sent;
              data = response === null || response === void 0 ? void 0 : response.data;

              if (!(0,_utilx__WEBPACK_IMPORTED_MODULE_2__.empty)(data)) {
                _templates_crash_view__WEBPACK_IMPORTED_MODULE_4__.renderDefaultHistoryView.call(this, data);
              }
